...
@Slf4j
@Service
public class PenRequestBatchStudentDefaultPenMatchResultProcessingService extends BaseBatchStudentPenMatchResultProcessingService {
   ...
   */
  public PenRequestBatchStudentDefaultPenMatchResultProcessingService(final PenRequestBatchStudentService penRequestBatchStudentService, final RestUtils restUtils, final PenService penService, final SagaService sagaService) {
