 ...
 * {@link ca.bc.gov.educ.penreg.api.repository.PenRequestBatchStudentRepository#findBatchFilesWithMultipleAssignedLocalIDs(List)}
 ...
 * @author om
 */
public interface PenRequestBatchMultipleLocalID {

  /**
   * @return the submission number for which, same local ID is assigned to multiple pen requests either by system or by the user.
   */
