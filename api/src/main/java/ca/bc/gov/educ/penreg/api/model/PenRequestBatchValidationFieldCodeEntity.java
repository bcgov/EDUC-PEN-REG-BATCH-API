...
/**
 * The type Pen request batch validation field code entity.
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
@Entity
@Table(name = "PEN_REQUEST_BATCH_VALIDATION_FIELD_CODE")
public class PenRequestBatchValidationFieldCodeEntity {
  /**
   * The Code.
   */
  @Id
