...
public class PenRequestBatchRepostReportsOrchestrator extends BaseReturnFilesOrchestrator<PenRequestBatchRepostReportsFilesSagaData> {
    ...
    public void populateStepsToExecuteMap() {
        stepBuilder()
          ...
          .step(GET_STUDENTS, STUDENTS_FOUND, this::isSfasBatchFile, SAVE_REPORTS, this::saveReportsWithoutPDF)
          .step(GET_STUDENTS, STUDENTS_FOUND, this::isNotSfasBatchFile, GENERATE_PEN_REQUEST_BATCH_REPORTS, this::generatePDFReport)
