...
CREATE TABLE MINISTRY_PRB_SOURCE_CODE
(
    MINISTRY_PRB_SOURCE_CODE VARCHAR2(10)           NOT NULL,
    LABEL                         VARCHAR2(30),
    DESCRIPTION                   VARCHAR2(255),
    ...
    UPDATE_USER                   VARCHAR2(32)           NOT NULL,
    UPDATE_DATE                   DATE   DEFAULT SYSDATE NOT NULL,
    CONSTRAINT MINISTRY_PRB_SOURCE_CODE_PK PRIMARY KEY (MINISTRY_PRB_SOURCE_CODE)
);
COMMENT ON TABLE MINISTRY_PRB_SOURCE_CODE IS 'Lists the ministry system that handle PEN Request Batch files, such as TSW PENWeb.';

ALTER TABLE PEN_REQUEST_BATCH
    ADD CONSTRAINT PEN_REQUEST_BATCH_MINISTRY_PRB_SOURCE_CODE_FK FOREIGN KEY (MINISTRY_PRB_SOURCE_CODE) REFERENCES MINISTRY_PRB_SOURCE_CODE (MINISTRY_PRB_SOURCE_CODE);
...
INSERT INTO MINISTRY_PRB_SOURCE_CODE (MINISTRY_PRB_SOURCE_CODE, LABEL, DESCRIPTION, DISPLAY_ORDER,
