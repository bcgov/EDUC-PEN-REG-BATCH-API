...
ADD (
    PEN_REQUEST_BATCH_PROCESS_TYPE_CODE    VARCHAR2(10) DEFAULT('FLAT_FILE')  NOT NULL
);

ALTER TABLE PEN_REQUEST_BATCH MODIFY PEN_REQUEST_BATCH_PROCESS_TYPE_CODE DEFAULT NULL;

COMMENT ON COLUMN PEN_REQUEST_BATCH.PEN_REQUEST_BATCH_PROCESS_TYPE_CODE IS 'The batch processing type used (API or FLAT_FILE).';
